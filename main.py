...
from networks.agent_unetr import AgentUNETR
...
parser = argparse.ArgumentParser(description="Agent UNETR segmentation pipeline")
...
parser.add_argument("--noamp", default=True, action="store_true", help="do NOT use amp for training")
...
parser.add_argument("--norm_name", default="instance", type=str, help="normalization namecon")
parser.add_argument("--workers", default=8, type=int, help="number of workers")
parser.add_argument("--feature_size", default=48, type=int, help="feature size")
parser.add_argument("--in_channels", default=, type=int, help="number of input channels")
parser.add_argument("--out_channels", default=, type=int, help="number of output channels")
